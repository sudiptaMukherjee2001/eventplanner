                ...
                loading ?
                    ...
                    <div className="musicEvent">
                        ...
                        <div className="categoryTitle">
                            <h1 style={{ fontSize: "21px", left: "271px", top: "25px", width: "57%", textAlign: "center" }}>Connect, learn, and engage in our dynamic online event</h1>
                        </div>
                        <div className="allMusicEventcards">
                            {events.map((musicEvent, index) => {
                                return (
                                    (musicEvent.approved && musicEvent.type === "Online Event") &&
